...
import { getSchedule, getScheduleForRoom, isInvalidDateError } from '../services/scheduleService.js';

export const getScheduleList: RequestHandler = async (req, res, next) => {
  try {
